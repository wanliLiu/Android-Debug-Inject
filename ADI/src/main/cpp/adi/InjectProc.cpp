...
void inject_process_test(){
    inject_process(17419, "/data/local/tmp/libDrmHook.so","DrmIdHook","11111111111193baf8cb6a22de8a5ae4bfecc174b1a9405dc71b8b3fac1c734f");
...
void func_test(int argc, char *argv[]){
    ...
    inject_remote_process(pid, "/data/local/tmp/libDrmHook.so3","_Z9DrmIdHookPvPKc","11111111111193baf8cb6a22de8a5ae4bfecc174b1a9405dc71b8b3fac1c734f");
    sleep(1);
}