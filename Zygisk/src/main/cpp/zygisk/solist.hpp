...
namespace SoList {
    ...
    public:
        ...
        inline static size_t field_soname_offset = 0x189;
#else
        ...
        inline static const char *(*get_soname)(SoInfo *) = nullptr;
        ...
        inline const char *getSoname() {
            if (get_soname) return get_soname(this);
